import fs from 'fs';
import type { ResponseLike } from 'premai-sdk-ts/internal/to-file';
import { toFile } from 'premai-sdk-ts/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('premai-sdk-ts/core/uploads');
    await expect(
