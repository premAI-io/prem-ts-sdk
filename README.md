...
```sh
npm install git+ssh://git@github.com:premAI-io/prem-ts-sdk.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/premAI-io/prem-ts-sdk/issues) with questions, bugs, or suggestions.
